...
def set_unit_heading(side:str, unit_name:str, heading:float) -> str:
  return f"ScenEdit_SetUnit({{side = '{side}', name = '{unit_name}', desiredHeading = {heading}}})"

def set_unit_speed(side:str, unit_name:str, speed:float) -> str:
  return f"ScenEdit_SetUnit({{side = '{side}', name = '{unit_name}', Speed = {speed}}})"
