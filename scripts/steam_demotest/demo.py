...
# MAIN LOOP
scenario_name = "Blue Dawn"
player_side = "South Korea"
scenario_script_folder_name = "steam_demotest"  # name of folder containing the lua script that the agent will use
